                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <a href="#" class="flex items-center">
                            ...
                            <span
                                class="text-gray-300 text-xl font-semibold mx-2"
                                >Dashboard</span
                            >
                        </a>
                    </div>
                    <div class="hidden md:block">
                        <div class="mx-10 flex items-baseline">
                            ...
                            <a
                                href="#"
                                class="mx-1 px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700"
                                >Link</a
                            >
                            <a
                                href="#"
