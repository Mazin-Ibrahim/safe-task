        ...
        <div class="px-2 py-6 md:block" :class="isOpen ? 'block' : 'hidden'">
            <ul>
                <!-- <li
                    ...
                    :class="
                        route().current('dashboard.index') ? 'bg-gray-900' : ''
                    "
                >
                    <inertia-link href="/dashboard" class="flex items-center">
                        <svg
                ...
                <li
                    class="px-2 py-3 hover:bg-gray-900 rounded mt-2"
                    :class="route().current('users.*') ? 'bg-gray-900' : ''"
                >
                    <inertia-link href="/users" class="flex items-center">
                        <svg
                            class="w-6 text-gray-500"
                            fill="none"
                            stroke-linecap="round"
                ...
                <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2">
                    ...
                    >
                        ...
                        <span class="mx-2 text-gray-300">Companies</span>
                    </inertia-link>
                </li>
                <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2">
                    <inertia-link
            ...
            <ul class="mt-6 md:hidden">
                ...
                <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2">
                    <button class="mx-2 text-gray-300" @click="logout">
                        Logout
                    </button>
                </li>
            </ul>
